...
\insertvideo{6OG7cKedT_E}{partie 12.1. Graphe}

\insertvideo{0RR4afRrJHc}{partie 12.2. Graphe du plan}

\insertvideo{fWGoTUcE9N8}{partie 12.3. Triangulation - Enveloppe convexe}

\insertvideo{0GlkWliN5ZQ}{partie 12.4. Triangulation d'un ensemble de points}

\insertvideo{2wraWknyBJo}{partie 12.5. Triangulation de Delaunay}

\insertvideo{_RbUIN_piUA}{partie 12.6. Cellules de Voronoï}
