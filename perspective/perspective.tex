...
\insertvideo{KdcVe0JTqHA}{partie 6.1. Perspective linéaire}

\insertvideo{rpbTV0DzTk0}{partie 6.2. Projection orthogonale}

\insertvideo{KLFm0tHEJB4}{partie 6.3. Projection parallèle}

\insertvideo{9RfMrmhaZ6M}{partie 6.4. Autres perspectives}
...
\myfigure{0.9}{\tikzinput{fig-perspective-09}}
